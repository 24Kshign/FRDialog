...
public class FRDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public Builder setMaterialDesign() {
        ...
        //设置MD效果dialog的头部
        public Builder setMaterialDesignTitle(CharSequence charSequence) {
            params.mMaterialDesignTitle = charSequence;
            return this;
        }

        //设置MD效果dialog内容
        public Builder setMaterialDesignContent(CharSequence charSequence) {
            params.mMaterialDesignContent = charSequence;
            return this;
        }

        //设置MD效果dialog取消和确认键文字
        public Builder setMaterialDesignNegativeAndPositive(CharSequence... charSequence) {
        ...
        public Builder setMaterialDesignNegativeAndPositiveTextColor(Integer... colors) {
            if (colors.length > 0) {
        ...
        //设置MD效果dialog确认键点击事件
        public Builder setMaterialDesignPositiveListener(View.OnClickListener onClickListener) {
            params.mPositiveListener = onClickListener;
            return this;
        }

        //设置MD效果dialog取消键点击事件（默认不设置的效果为弹窗消失）
        public Builder setMaterialDesignNegativeListener(View.OnClickListener onClickListener) {
